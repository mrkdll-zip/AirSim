...
MSGPACK_API_VERSION_NAMESPACE(v1) {
    ...
    public:
        ...
        /// Constructor that creates an object_handle holding object `obj` and
        /// zone `z`.
        /**
         * @param obj object
         * @param z zone
         */
        object_handle(clmdep_msgpack::object const &obj,
        ...
        void set(clmdep_msgpack::object const &obj) { m_obj = obj; }

        /// Get object reference
        /**
         * @return object
         */
        const clmdep_msgpack::object &get() const { return m_obj; }
        ...
        object_handle(object_handle &other)
            : m_obj(other.m_obj), m_zone(clmdep_msgpack::move(other.m_zone)) {}
...
#endif // defined(MSGPACK_USE_CPP03)
        template <typename T> T as() { return get().as<T>(); }
    ...
    inline std::size_t aligned_zone_size(clmdep_msgpack::object const &obj) {
        ...
        case clmdep_msgpack::type::EXT:
            s += clmdep_msgpack::aligned_size(
                detail::add_ext_type_size<sizeof(std::size_t)>(
                    obj.via.ext.size),
    ...
    inline object_handle clone(clmdep_msgpack::object const &obj) {
        ...
        clmdep_msgpack::unique_ptr<clmdep_msgpack::zone> z(
            size == 0 ? MSGPACK_NULLPTR : new clmdep_msgpack::zone(size));
        clmdep_msgpack::object newobj =
            z.get() ? clmdep_msgpack::object(obj, *z) : obj;
    ...
    template <typename Stream, typename T> struct packer_serializer {
        static clmdep_msgpack::packer<Stream> &
        pack(clmdep_msgpack::packer<Stream> &o, const T &v) {
            v.msgpack_pack(o);
            return o;
        }
    };
    ...
    inline clmdep_msgpack::object const &
    adaptor::convert<T, Enabler>::operator()(clmdep_msgpack::object const &o,
                                             T &v) const {
    ...
    inline clmdep_msgpack::packer<Stream> &
    adaptor::pack<T, Enabler>::operator()(clmdep_msgpack::packer<Stream> &o,
                                          T const &v) const {
        return clmdep_msgpack::detail::packer_serializer<Stream, T>::pack(o, v);
    }

    template <typename T, typename Enabler>
    inline void adaptor::object_with_zone<T, Enabler>::operator()(
        clmdep_msgpack::object::with_zone &o, T const &v) const {
    ...
    template <> struct convert<clmdep_msgpack::object> {
        clmdep_msgpack::object const &
        operator()(clmdep_msgpack::object const &o,
                   clmdep_msgpack::object &v) const {
            v = o;
            return o;
        }
    };

    template <> struct pack<clmdep_msgpack::object> {
        template <typename Stream>
        clmdep_msgpack::packer<Stream> &
        operator()(clmdep_msgpack::packer<Stream> &o,
                   clmdep_msgpack::object const &v) const {
            switch (v.type) {
    ...
    template <> struct object_with_zone<clmdep_msgpack::object> {
        void operator()(clmdep_msgpack::object::with_zone &o,
            ...
            case clmdep_msgpack::type::STR: {
                char *ptr = static_cast<char *>(o.zone.allocate_align(
                    v.via.str.size, MSGPACK_ZONE_ALIGNOF(char)));
                o.via.str.ptr = ptr;
            ...
            case clmdep_msgpack::type::BIN: {
                char *ptr = static_cast<char *>(o.zone.allocate_align(
                    v.via.bin.size, MSGPACK_ZONE_ALIGNOF(char)));
                o.via.bin.ptr = ptr;
            ...
            case clmdep_msgpack::type::EXT: {
                char *ptr = static_cast<char *>(o.zone.allocate_align(
                    v.via.ext.size + 1, MSGPACK_ZONE_ALIGNOF(char)));
                o.via.ext.ptr = ptr;
            ...
            case clmdep_msgpack::type::ARRAY:
                o.via.array.ptr =
                    static_cast<clmdep_msgpack::object *>(o.zone.allocate_align(
                        sizeof(clmdep_msgpack::object) * v.via.array.size,
                        MSGPACK_ZONE_ALIGNOF(clmdep_msgpack::object)));
                o.via.array.size = v.via.array.size;
                for (clmdep_msgpack::object *po(o.via.array.ptr),
                     *pv(v.via.array.ptr),
            ...
            case clmdep_msgpack::type::MAP:
                o.via.map.ptr =
                    (clmdep_msgpack::object_kv *)o.zone.allocate_align(
                        sizeof(clmdep_msgpack::object_kv) * v.via.map.size,
                        MSGPACK_ZONE_ALIGNOF(clmdep_msgpack::object_kv));
                o.via.map.size = v.via.map.size;
                for (clmdep_msgpack::object_kv *po(o.via.map.ptr),
                     *pv(v.via.map.ptr),
                         *const pvend(v.via.map.ptr + v.via.map.size);
                     pv < pvend; ++po, ++pv) {
                    clmdep_msgpack::object_kv *kv =
                        new (po) clmdep_msgpack::object_kv;
    ...
    template <> struct object_with_zone<clmdep_msgpack::object::with_zone> {
        void operator()(clmdep_msgpack::object::with_zone &o,
    ...
    inline bool operator==(const clmdep_msgpack::object &x,
                           const clmdep_msgpack::object &y) {
        if (x.type != y.type) {
            return false;
        }
        ...
        case clmdep_msgpack::type::BIN:
            return x.via.bin.size == y.via.bin.size &&
                   std::memcmp(x.via.bin.ptr, y.via.bin.ptr, x.via.bin.size) ==
                       0;

        case clmdep_msgpack::type::EXT:
            return x.via.ext.size == y.via.ext.size &&
                   std::memcmp(x.via.ext.ptr, y.via.ext.ptr, x.via.ext.size) ==
                       0;
        ...
        case clmdep_msgpack::type::ARRAY:
            if (x.via.array.size != y.via.array.size) {
                ...
                clmdep_msgpack::object *const pxend =
                    x.via.array.ptr + x.via.array.size;
        ...
        case clmdep_msgpack::type::MAP:
            if (x.via.map.size != y.via.map.size) {
                ...
                clmdep_msgpack::object_kv *const pxend =
                    x.via.map.ptr + x.via.map.size;
    ...
    template <typename T>
    inline bool operator==(const clmdep_msgpack::object &x, const T &y) try {
    ...
    template <typename T>
    inline typename clmdep_msgpack::enable_if<
    ...
    template <typename T>
    inline
        typename clmdep_msgpack::enable_if<clmdep_msgpack::is_pointer<T>::value,
                                           T>::type
        object::convert(T v) const {
        convert(*v);
        return v;
    ...
    template <typename T>
    inline typename std::enable_if<clmdep_msgpack::has_as<T>::value, T>::type
    object::as() const {
    ...
    inline object::object() { type = clmdep_msgpack::type::NIL; }
    ...
    template <typename Stream>
    inline clmdep_msgpack::packer<Stream> &operator<<(
        clmdep_msgpack::packer<Stream> &o, const clmdep_msgpack::object &v) {
        switch (v.type) {
        case clmdep_msgpack::type::NIL:
            o.pack_nil();
            return o;
    ...
    inline clmdep_msgpack::packer<Stream> &operator<<(
        ...
        const clmdep_msgpack::object::with_zone &v) {
    ...
    inline std::ostream &operator<<(std::ostream &s,
            ...
            for (uint32_t i = 0; i < o.via.str.size; ++i) {
                ...
                default: {
                    ...
                    if (code < 0x20 || code == 0x7f) {
                        ...
                        s << "\\u" << std::hex << std::setw(4)
                          << std::setfill('0') << (code & 0xff);
                        s.flags(flags);
                    } else {
                        s << c;
                    }
        ...
        case clmdep_msgpack::type::ARRAY:
            ...
            if (o.via.array.size != 0) {
                ...
                s << *p;
                ++p;
                for (clmdep_msgpack::object *const pend(o.via.array.ptr +
                                                        o.via.array.size);
                     p < pend; ++p) {
                    s << ", " << *p;
                }
        ...
        case clmdep_msgpack::type::MAP:
            ...
            if (o.via.map.size != 0) {
                ...
                s << p->key << ':' << p->val;
                ++p;
                for (clmdep_msgpack::object_kv *const pend(o.via.map.ptr +
                                                           o.via.map.size);
                     p < pend; ++p) {
                    s << ", " << p->key << ':' << p->val;
                }
