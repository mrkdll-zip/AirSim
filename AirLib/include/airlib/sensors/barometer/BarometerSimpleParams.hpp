...
Ref: A Stochastic Approach to Noise Modeling for Barometric Altimeters
   ...
   This is however not used because numbers mentioned in paper doesn't match
experiments.
...
*/
  ...
  // Experiments for MEAS MS56112 sensor shows 0.021mbar, datasheet has resoultion of
  // 0.027mbar @ 1024
  ...
  void initializeFromSettings(const AirSimSettings::BarometerSetting& settings)
  {
    ...
    uncorrelated_noise_sigma =
        json.getFloat("UncorrelatedNoiseSigma", uncorrelated_noise_sigma);
