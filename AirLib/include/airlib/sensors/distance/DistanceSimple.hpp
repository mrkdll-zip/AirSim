...
class DistanceSimple : public DistanceBase {
  public:
  DistanceSimple(const AirSimSettings::DistanceSetting& setting =
                     AirSimSettings::DistanceSetting())
  ...
  DistanceSensorData getOutputInternal()
  {
    ...
    // order of Pose addition is important here because it also adds quaternions which
    // is not commutative!
