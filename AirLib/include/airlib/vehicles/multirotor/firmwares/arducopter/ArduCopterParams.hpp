...
#include "airlib/vehicles/multirotor/firmwares/arducopter/ArduCopterApi.hpp"
...
class ArduCopterParams : public MultiRotorParams {
  public:
  ArduCopterParams(const AirSimSettings::MavLinkVehicleSetting& vehicle_setting,
  ...
  virtual std::unique_ptr<MultirotorApiBase> createMultirotorApi() override
  {
    return std::unique_ptr<MultirotorApiBase>(
        new ArduCopterApi(this, connection_info_));
  }
