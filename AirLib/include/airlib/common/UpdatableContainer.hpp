...
class UpdatableContainer : public UpdatableObject {
  ...
  {
    for (TUpdatableObjectPtr& member : members_) member->reset();
  }
  ...
  virtual void update() override
  {
    ...
    for (TUpdatableObjectPtr& member : members_) member->update();
  }

  virtual void reportState(StateReporter& reporter) override
  {
    for (TUpdatableObjectPtr& member : members_) member->reportState(reporter);
  }
